...
print {$runner_fh} "SCRIPT_DIR=\"\$2\"\n";
print {$runner_fh} $function, "\napply_series_white_reference_to_steps 711.680157\n";
close $runner_fh;

my $shared_math_dir = File::Spec->catdir($Bin, '..', 'usr', 'bin');
is(system('bash', $runner, $steps_file, $shared_math_dir), 0, 'worker applies fresh measured white');
