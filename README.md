...
- **Display profile creation** — measured Windows MHC2 profiles and KDE HDR cLUT profiles can be built in the browser. KDE HDR output uses the bundled ArgyllCMS ICC v4.4 path with Rec. 2020/PQ CICP metadata, optional VCGT handling, and OLED near-black cLUT stabilization.
