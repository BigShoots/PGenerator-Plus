...
- LG 26pt EOTF/luminance charts should not plot the synthetic/legal-white 100% reference point; use 99% as the top legal-white plot point. Keep the 0% black dot visible, but do not connect it with a measured line segment to 2.3% because that straight segment visually breaks the low-shadow curve.
