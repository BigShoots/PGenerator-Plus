...
- Current full-DDC spine anchors are `109,105,99,75,50,25`, then remaining body points run downward to 15%, and the shadow-detail pass runs upward from `2.3,3,4,5,7,10`. 5% is not a spine anchor.
