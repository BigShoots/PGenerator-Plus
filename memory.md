...
- Current full-DDC spine anchors are `109,105,99,75,50,25,5`, then remaining body points run downward to 15%, and the shadow-detail pass runs upward from `2.3,3,4,7,10` because 5% is already solved as the low anchor.
