...
- Current full-DDC spine anchors are `109,20,40,60,80`, then remaining body points run downward from 105% to 15%, and the shadow-detail pass runs upward from `2.3,3,4,5,7,10`.
