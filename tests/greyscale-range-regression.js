...
assert(
    ...
    autocalWorkerSource.includes('return 84.93 if(abs($value-79.91) < 0.02);') &&
	  ...
	  'HDR20 AutoCal should use code-derived HDR weighted patches with the LG high-end shifted DDC slots, calibrate 100% instead of SDR-style paired 99/100, use the supplied AutoCal target curve, and avoid luma-only HDR100 moves while chroma is still high'
	);
assert(
